  ...
  if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
    var e, t, o, i, n, r, s, a = {
      ...
      l = {
        ...
        embedStylesForCopyright: function () {
          ...
          return e.innerHTML = ".tradingview-widget-copyright {font-size: 13px !important; line-height: 32px !important; text-align: center !important; vertical-align: middle !important; font-family: " + d + " !important; color: " + a["color-gull-gray"] + " !important;} .tradingview-widget-copyright .blue-text {color: " + a["color-brand"] + " !important;} .tradingview-widget-copyright a {text-decoration: none !important; color: " + a["color-gull-gray"] + " !important;} .tradingview-widget-copyright a:visited {color: " + a["color-gull-gray"] + " !important;} .tradingview-widget-copyright a:hover .blue-text {color: " + a["color-brand-hover"] + " !important;} .tradingview-widget-copyright a:active .blue-text {color: " + a["color-brand-active"] + " !important;} .tradingview-widget-copyright a:visited .blue-text {color: " + a["color-brand"] + " !important;}", e
        },
        ...
        generateUtmForUrlParams: function (e) {
          return "utm_source=" + encodeURI(window.location.hostname) + "&utm_medium=" + (l.hasCopyright(e.container) ? "widget_new" : "widget") + (e.type ? "&utm_campaign=" + e.type : "") + (e.type && "chart" === e.type ? "&utm_term=" + encodeURIComponent(e.symbol) : "")
        },
    ...
    l.WidgetAbstract.prototype = {
      ...
      addWrapperFrame: function (e, t, o) {
        ...
        o = o || "transparent";
        return '<div id="' + this.id + '-wrapper" style="position: relative;box-sizing: content-box;width: ' + n + ";height: " + i + ";margin: 0 auto !important;padding: 0 !important;font-family: " + d + ';"><div style="width: ' + n + ";height: " + i + ";background: " + o + ';padding: 0 !important;">' + e + "</div>" + (t || "") + "</div>"
      },
      addFooterLogo: function (e, t) {
        var o = (t || {}).greyText || "powered by",
          i = (t || {}).linkText || "tradingview.com",
          n = (t || {}).href || "https://www.tradingview.com/";
        return l.WidgetAbstract.prototype.addWrapperFrame.call(this, e, '<div style="position:absolute;display: block;box-sizing: content-box;height: 24px;width: ' + l.WidgetAbstract.prototype.width.call(this) + ";bottom: 0;left: 0;margin: 0;padding: 0;font-family: " + d + ';"><div style="display: block;margin: 0 1px 1px 1px;line-height: 7px;box-sizing: content-box;height: 11px;padding: 6px 10px;text-align: right;background: #fff;"><a href="' + n + "?" + l.generateUtmForUrlParams(this.options) + '" target="_blank" style="color: #0099d4;text-decoration: none;font-size: 11px;"><span style="color: #b4b4b4;font-size: 11px;">' + o + "</span> " + i + "</a></div></div>", "#fff")
      }
    }, l.ChatWidgetEmbed.prototype = {
      createWidget: function () {
        var e = this.widgetCode();
        e = l.WidgetAbstract.prototype.addFooterLogo.call(this, e), h(e, this.options.container)
      },
      widgetCode: function () {
        ...
        return '<iframe src="' + (l.chatHost + "/chatwidgetembed/?" + o + t + e) + '"' + (this.options.width ? ' width="' + this.options.width + '"' : "") + (this.options.height ? ' height="' + this.options.height + '"' : "") + ' frameborder="0" allowTransparency="true" scrolling="no"></iframe>'
      }
      ...
      createWidget: function () {
        ...
        this.postMessage = l.postMessageWrapper(o.contentWindow, this.id), this.postMessage.on("resize", (function (e) {
      ...
      widgetCode: function () {
        ...
        var t = "&" + l.generateUtmForUrlParams(this.options);
        return '<iframe src="' + (l.getHost(this.options) + "/eventswidgetembed/?" + e + t) + '" width="' + this.options.width + '"' + (this.options.height ? ' height="' + this.options.height + '"' : "") + ' frameborder="0" scrolling="no"></iframe>'
      }
      ...
      createWidget: function () {
        ...
        var t = this,
          o = document.getElementById(this.id);
        this.postMessage = l.postMessageWrapper(o.contentWindow, this.id), l.bindEvent(o, "load", (function () {
          t._ready = !0;
      ...
      widgetCode: function () {
        ...
        return '<iframe id="' + this.id + '" src="' + f + '" style="margin: 0 !important; padding: 0 !important; ' + (this.options.width ? "width: " + this.options.width + "; " : "") + (this.options.height ? "height: " + this.options.height + ";" : "") + '" frameborder="0" allowTransparency="true" scrolling="no"></iframe>'
      },
      remove: function () {
        var e = document.getElementById("tradingview_widget");
        e.parentNode.removeChild(e)
      ...
      create: function () {
        ...
        var e = this.render(),
          t = this;
        this.options.noLogoOverlay || (e = l.WidgetAbstract.prototype.addWrapperFrame.call(this, e)), h(e, this.options.container);
        var o = document.getElementById("tradingview-copyright");
        o && o.parentElement && o.parentElement.removeChild(o), this.iframe = document.getElementById(this.id), this.postMessage = l.postMessageWrapper(this.iframe.contentWindow, this.id), l.bindEvent(this.iframe, "load", (function () {
          ...
          var a = t.options.popup_width || 900,
            ...
            h = (screen.width - a) / 2,
            c = (screen.height - d) / 2,
            p = window.open(t.generateUrl(o), "_blank", "resizable=yes, top=" + c + ", left=" + h + ", width=" + a + ", height=" + d);
          p && (p.opener = null)
        }))
      },
      ready: function (e) {
      ...
      create: function () {
        ...
        var e, t = this.render(),
          o = this;
        l.chartCssAttached || (l.css(this.renderCss()), l.chartCssAttached = !0), h(t, this.options.container), e = document.getElementById(this.id), l.bindEvent(e, "load", (function () {
          var e;
        ...
        })), this.postMessage = l.postMessageWrapper(e.contentWindow, this.id), this.postMessage.on("toggleFullscreen", (function (t) {
      ...
      render: function () {
        var e = this.options.mobileStatic && this.isMobile ? l.host + "/embed-static/" : l.host + "/embed/",
    ...
    }, l.postMessageWrapper = (o = {}, i = {}, n = {}, r = 0, s = 0, window.addEventListener && window.addEventListener("message", (function (e) {
      var n;
      try {
        n = JSON.parse(e.data)
      } catch (e) {
      ...
      if (n && n.provider && "TradingView" === n.provider)
        ...
        } else if ("on" === n.type) o[n.client_id] && o[n.client_id][n.id] && (o[n.client_id][n.id].call(n, n.data), delete o[n.client_id][n.id]);
      else if ("post" === n.type) {
        if (!i[n.name]) return;
        i[n.name].forEach((function (e) {
      ...
      for (var e = /\+/g, t = /([^&=]+)=?([^&]*)/g, o = window.location.search.substring(1), i = t.exec(o), n = function (t) {
          return decodeURIComponent(t.replace(e, " "))
        }, r = {}; i;) r[n(i[1])] = n(i[2]), i = t.exec(o);
      return r
